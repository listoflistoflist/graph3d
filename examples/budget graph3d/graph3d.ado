...
XLPos(int 0) YLPos(int 0) ZLPos(int 0) XLANGle(int 0) YLANGle(int 0) ZLANGle(int 0) BLVertices SCALEX(real 1) SCALEY(real 1) SCALEZ(real 1) ///
...
local z_coor `3'
	if `scalex'!=0{
		qui gen double `x' = `1'/`scalex'
	}
	if `scalex'==0{
		qui gen double `x' = `1'/0.00001
	}
	if `scaley'!=0{
		qui gen double `y' = `2'/`scaley'
	}
	if `scaley'==0{
		qui gen double `y' = `2'/0.00001
	}
	if `scalez'!=0{
		qui gen double `z' = `3'/`scalez'
	}
	if `scalez'==0{
		qui gen double `z' = `3'/0.00001
	}
qui su `x'
local x_center = r(min)+(r(max) - r(min))/2
local dist=0-`x_center'
qui replace `x'=`x'+`dist'

qui su `y'
local y_center = r(min)+(r(max) - r(min))/2
local dist=0-`y_center'
qui replace `y'=`y'+`dist'

qui su `z'
local z_center = r(min)+(r(max) - r(min))/2
local dist=0-`z_center'
qui replace `z'=`z'+`dist'
...
pr _draw
	...
	if "`cuboid'" == "true"{
		...
		qui replace `pos' = 5 if _n==4
		qui replace `pos' = 9 if _n==5
		qui replace `pos' = 6 if _n==7
		qui replace `pos' = 6 if _n==8
		
*		local drawgrid "`drawgrid' (connected `gvar2' `gvar1' if _n==9 | _n==10, m(i) lc(ltbluishgray) lpattern(dash))"
*		local drawgrid "`drawgrid' (connected `gvar2' `gvar1' if _n==9 | _n==11, m(i) lc(ltbluishgray) lpattern(dash)) "
*		local drawgrid "`drawgrid' (connected `gvar2' `gvar1' if _n==10 | _n==12, m(i) lc(ltbluishgray) lpattern(dash)) "
		local drawgrid "`drawgrid' (connected `gvar2' `gvar1' if _n==11 | _n==12, m(i) lc(ltbluishgray) lpattern(dash)) "
		local drawgrid "`drawgrid' (connected `gvar2' `gvar1' if _n==13 | _n==14, m(i) lc(ltbluishgray) lpattern(dash)) "
		local drawgrid "`drawgrid' (connected `gvar2' `gvar1' if _n==13 | _n==15, m(i) lc(ltbluishgray) lpattern(dash)) "
		local drawgrid "`drawgrid' (connected `gvar2' `gvar1' if _n==14 | _n==16, m(i) lc(ltbluishgray) lpattern(dash)) "
		local drawgrid "`drawgrid' (connected `gvar2' `gvar1' if _n==15 | _n==16, m(i) lc(ltbluishgray) lpattern(dash)) "
*		local drawgrid "`drawgrid' (connected `gvar2' `gvar1' if _n==17 | _n==18, m(i) lc(ltbluishgray) lpattern(dash))"
		local drawgrid "`drawgrid' (connected `gvar2' `gvar1' if _n==17 | _n==19, m(i) lc(ltbluishgray) lpattern(dash)) "
*		local drawgrid "`drawgrid' (connected `gvar2' `gvar1' if _n==18 | _n==20, m(i) lc(ltbluishgray) lpattern(dash)) "
*		local drawgrid "`drawgrid' (connected `gvar2' `gvar1' if _n==19 | _n==20, m(i) lc(ltbluishgray) lpattern(dash)) "
		local drawgrid "`drawgrid' (connected `gvar2' `gvar1' if _n==21 | _n==22, m(i) lc(ltbluishgray) lpattern(dash)) "
		local drawgrid "`drawgrid' (connected `gvar2' `gvar1' if _n==21 | _n==23, m(i) lc(ltbluishgray) lpattern(dash)) "
		local drawgrid "`drawgrid' (connected `gvar2' `gvar1' if _n==22 | _n==24, m(i) lc(ltbluishgray) lpattern(dash)) "
		local drawgrid "`drawgrid' (connected `gvar2' `gvar1' if _n==23 | _n==24, m(i) lc(ltbluishgray) lpattern(dash)) "
*		local drawgrid "`drawgrid' (connected `gvar2' `gvar1' if _n==25 | _n==26, m(i) lc(ltbluishgray) lpattern(dash))"
		local drawgrid "`drawgrid' (connected `gvar2' `gvar1' if _n==25 | _n==27, m(i) lc(ltbluishgray) lpattern(dash)) "
*		local drawgrid "`drawgrid' (connected `gvar2' `gvar1' if _n==26 | _n==28, m(i) lc(ltbluishgray) lpattern(dash)) "
		local drawgrid "`drawgrid' (connected `gvar2' `gvar1' if _n==27 | _n==28, m(i) lc(ltbluishgray) lpattern(dash)) "
*		local drawgrid "`drawgrid' (connected `gvar2' `gvar1' if _n==29 | _n==30, m(i) lc(ltbluishgray) lpattern(dash)) "
		local drawgrid "`drawgrid' (connected `gvar2' `gvar1' if _n==29 | _n==31, m(i) lc(ltbluishgray) lpattern(dash)) "
*		local drawgrid "`drawgrid' (connected `gvar2' `gvar1' if _n==30 | _n==32, m(i) lc(ltbluishgray) lpattern(dash)) "
		local drawgrid "`drawgrid' (connected `gvar2' `gvar1' if _n==31 | _n==32, m(i) lc(ltbluishgray) lpattern(dash)) "
		
*		local drawgrid "`drawgrid' (connected `gvar2' `gvar1' if _n==9  | _n==13, m(i) lc(ltbluishgray) lpattern(dash)) "
		local drawgrid "`drawgrid' (connected `gvar2' `gvar1' if _n==12 | _n==16, m(i) lc(ltbluishgray) lpattern(dash)) "
		local drawgrid "`drawgrid' (connected `gvar2' `gvar1' if _n==11 | _n==15, m(i) lc(ltbluishgray) lpattern(dash)) "
*		local drawgrid "`drawgrid' (connected `gvar2' `gvar1' if _n==10 | _n==14, m(i) lc(ltbluishgray) lpattern(dash)) "

		
		local drawgrid "`drawgrid' (connected `gvar2' `gvar1' if _n==17 | _n==21, m(i) lc(ltbluishgray) lpattern(dash)) "
*		local drawgrid "`drawgrid' (connected `gvar2' `gvar1' if _n==20 | _n==24, m(i) lc(ltbluishgray) lpattern(dash)) "
		local drawgrid "`drawgrid' (connected `gvar2' `gvar1' if _n==19 | _n==23, m(i) lc(ltbluishgray) lpattern(dash)) "
*		local drawgrid "`drawgrid' (connected `gvar2' `gvar1' if _n==18 | _n==22, m(i) lc(ltbluishgray) lpattern(dash)) "

*		local drawgrid "`drawgrid' (connected `gvar2' `gvar1' if _n==25 | _n==29, m(i) lc(ltbluishgray) lpattern(dash)) "
		local drawgrid "`drawgrid' (connected `gvar2' `gvar1' if _n==28 | _n==32, m(i) lc(ltbluishgray) lpattern(dash)) "
		local drawgrid "`drawgrid' (connected `gvar2' `gvar1' if _n==27 | _n==31, m(i) lc(ltbluishgray) lpattern(dash)) "
*		local drawgrid "`drawgrid' (connected `gvar2' `gvar1' if _n==26 | _n==30, m(i) lc(ltbluishgray) lpattern(dash)) "

		local drawgrid "`drawgrid' (connected `gvar2' `gvar1' if _n==13 , mlabgap(*3) m(i) mlabsize(medium) mlabcolor(black) mlabel(`xlab') mlabv(`xlabelpos') mlabangle(`xlangle') m(i) lc(none) lpattern(dash)) "
		local drawgrid "`drawgrid' (connected `gvar2' `gvar1' if _n==29,  mlabgap(*3) m(i) mlabsize(medium) mlabcolor(black) mlabel(`zlab') mlabv(`zlabelpos') mlabangle(`zlangle') m(i) lc(none) lpattern(dash)) "
		local drawgrid "`drawgrid' (connected `gvar2' `gvar1' if _n==4 , mlabgap(*6) m(i) mlabsize(medium) mlabcolor(black) mlabel(`ylab') mlabv(`ylabelpos') mlabangle(`ylangle') m(i) lc(none) lpattern(dash)) "

		/*coordinates*/
		local drawgrid "`drawgrid' (connected `gvar2' `gvar1' if _n==1 | _n==2, `mlc' mlabel(`label') mlabv(`pos') lc(edkblue))"
		local drawgrid "`drawgrid' (connected `gvar2' `gvar1' if _n==1 | _n==3, `mlc' mlabel(`label') mlabv(`pos') lc(edkblue)) "
		local drawgrid "`drawgrid' (connected `gvar2' `gvar1' if _n==2 | _n==4, `mlc' mlabel(`label') mlabv(`pos') lc(edkblue)) "
		local drawgrid "`drawgrid' (connected `gvar2' `gvar1' if _n==3 | _n==4, `mlc' mlabel(`label') mlabv(`pos') lc(edkblue)) "
*		local drawgrid "`drawgrid' (connected `gvar2' `gvar1' if _n==5 | _n==6, `mlc' mlabel(`label') mlabv(`pos') lc(edkblue)) "
		local drawgrid "`drawgrid' (connected `gvar2' `gvar1' if _n==5 | _n==7, `mlc' mlabel(`label') mlabv(`pos') lc(edkblue)) "
*		local drawgrid "`drawgrid' (connected `gvar2' `gvar1' if _n==6 | _n==8, `mlc' mlabel(`label') mlabv(`pos') lc(edkblue)) "
		local drawgrid "`drawgrid' (connected `gvar2' `gvar1' if _n==7 | _n==8, `mlc' mlabel(`label') mlabv(`pos') lc(edkblue)) "
		
		local drawgrid "`drawgrid' (connected `gvar2' `gvar1' if _n==1 | _n==5, `mlc' lc(edkblue)) "
		local drawgrid "`drawgrid' (connected `gvar2' `gvar1' if _n==4 | _n==8, `mlc' lc(edkblue)) "
		local drawgrid "`drawgrid' (connected `gvar2' `gvar1' if _n==3 | _n==7, `mlc' lc(edkblue)) "
*		local drawgrid "`drawgrid' (connected `gvar2' `gvar1' if _n==2 | _n==6, `mlc' lc(edkblue)) "
	}	
	qui gen `sorter'=_n
	...
	if "`wire'"=="true"{
		...
		foreach l of local levels{ 
			local grlines "`grlines' (line `var2' `var1' if `x'+0.0001>=`l' & `x'-0.0001<=`l', lc(gs10) lwidth(vvthin) sort(`z'))"	
		}
		qui levelsof `z', local(levels)
		foreach l of local levels{
			local grlines "`grlines' (line `var2' `var1' if `z'+0.0001>=`l' & `z'-0.0001<=`l', lc(gs11) lwidth(vvthin) sort(`x'))"	
		}
	}
	sort `sorter'
	tw `drawgrid' `grlines' `draw' /// 
	, aspect(`asratio') xlabel(-2(1)2, nogrid) ylabel(-2(1)2, nogrid) legend(off) yscale(off) xscale(off) plotr(c(none)) graphregion(color(white) m(l+30 r+30))
end
